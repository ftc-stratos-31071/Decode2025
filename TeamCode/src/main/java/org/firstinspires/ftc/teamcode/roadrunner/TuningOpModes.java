...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = AutoMecanumDrive.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(AutoMecanumDrive.class)) {
            dvf = hardwareMap -> {
                AutoMecanumDrive md = new AutoMecanumDrive(hardwareMap, new Pose2d(0, 0, 0));
                ...
                if (md.localizer instanceof AutoMecanumDrive.DriveLocalizer) {
                    AutoMecanumDrive.DriveLocalizer dl = (AutoMecanumDrive.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        AutoMecanumDrive.PARAMS.inPerTick,
                        AutoMecanumDrive.PARAMS.maxWheelVel,
                        AutoMecanumDrive.PARAMS.minProfileAccel,
                        AutoMecanumDrive.PARAMS.maxProfileAccel,
                        encoderGroups,
                        Arrays.asList(
                                md.leftFront,
                                md.leftBack
                        ...
                        lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(AutoMecanumDrive.PARAMS.kS,
                                AutoMecanumDrive.PARAMS.kV / AutoMecanumDrive.PARAMS.inPerTick,
                                AutoMecanumDrive.PARAMS.kA / AutoMecanumDrive.PARAMS.inPerTick),
                        0
                );
            };
