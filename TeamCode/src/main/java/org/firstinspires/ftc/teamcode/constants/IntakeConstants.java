...
public class IntakeConstants {
    ...
    public static double intakePowerSlow = 0.75;
    
    
    public static double shootPower = 1.0;
    public static double zeroPower = 0.0;
    public static double defaultPos = 0.41;
    public static double servoPos = 0.51;
    public static double reverseTime = 0.15;
    public static double shootTimeFirst = 0.4;
    public static double shootTime = 0.15;
    public static double shootTimeCont = 1.2;
    public static double shootTimeCont2 = 1.5;
