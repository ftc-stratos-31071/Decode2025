package org.firstinspires.ftc.teamcode.testing.tuning;
...
public class PedroTuning extends SelectableOpMode {
     ...
     */
    static class LocalizationTest extends OpMode {
        @Override
        public void init() {
     ...
     */
    static class LateralTuner extends OpMode {
        public static double DISTANCE = 48;
     ...
     * @version 1.0, 5/6/2024
     */
    static class TurnTuner extends OpMode {
     ...
     */
    static class ForwardVelocityTuner extends OpMode {
     ...
     * @version 1.0, 3/13/2024
     */
    static class ForwardZeroPowerAccelerationTuner extends OpMode {
     ...
     * @version 1.0, 3/13/2024
     */
    static class LateralZeroPowerAccelerationTuner extends OpMode {
        private final ArrayList<Double> accelerations = new ArrayList<>();
        public static double VELOCITY = 30;
        private double previousVelocity;
        private long previousTimeNano;
     ...
     */
    static class TranslationalTuner extends OpMode {
     ...
     * @version 1.0, 3/12/2024
     */
    static class HeadingTuner extends OpMode {
        public static double DISTANCE = 40;
        private boolean forward = true;
     ...
     * @version 1.0, 3/12/2024
     */
    static class DriveTuner extends OpMode {
        public static double DISTANCE = 40;
        private boolean forward = true;
     ...
     * @version 1.0, 3/12/2024
     */
    static class Line extends OpMode {
        public static double DISTANCE = 40;
        private boolean forward = true;
     ...
     * @version 1.0, 3/13/2024
     */
    static class CentripetalTuner extends OpMode {
     ...
     */
    static class Triangle extends OpMode {
     ...
     * @version 1.0, 3/12/2024
     */
    static class Circle extends OpMode {
